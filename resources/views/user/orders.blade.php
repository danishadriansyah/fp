...
/* Delivered */
.badge.bg-success {
    background-color: #28a745 !important; /* Hijau cerah */
...
/* Ordered */
.badge.bg-warning {
    background-color: #ffc107 !important; /* Kuning cerah */
    color: #000000 !important; /* Teks hitam untuk kontras */
    font-weight: bold;
}
...
.menu-link_active {
    ...
    font-weight: bold; /* Teks tebal */
    text-decoration: underline; /* Hapus garis bawah jika ada */
}
