...
<style>
    ...
    .badge {
        ...
        padding: 0.5em 0.75em; /* Padding untuk memperbesar area */
    ...
    .badge.bg-success {
        ...
        border: 1px solid #218838; /* Tambahkan border hijau gelap untuk penegasan */
    }

    /* Badge untuk status 'Declined' */
    .badge.bg-danger {
        background-color: #dc3545 !important; /* Warna merah */
        color: #ffffff !important; /* Teks putih */
        border: 1px solid #c82333; /* Tambahkan border merah gelap */
    }

    /* Badge untuk status 'Refunded' */
    .badge.bg-secondary {
        background-color: #6c757d !important; /* Warna abu-abu */
        color: #ffffff !important; /* Teks putih */
        border: 1px solid #5a6268; /* Tambahkan border abu-abu gelap */
    }
    ...
    .badge.bg-warning {
        ...
        border: 1px solid #e0a800; /* Tambahkan border kuning gelap */
    }
    ...
    width: 250px; /* Sesuaikan ukuran lebar sesuai kebutuhan */
    }
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="pname">
                                <div class="image">
                                    <img src="{{ asset('uploads/products/thumbnails/' . ($orderitem->product->image ?? 'default.png')) }}" alt="">
                                </div>
                                <div class="name">
